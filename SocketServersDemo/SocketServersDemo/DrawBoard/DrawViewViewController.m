...
#import "DrawViewViewController.h"
...
@interface DrawViewViewController () <GCDAsyncUdpSocketDelegate>
@property (nonatomic, strong) GCDAsyncUdpSocket *udpSocket;
@property (weak, nonatomic) IBOutlet DrawView *drawView;
@end

@implementation DrawViewViewController
    ...
    self.drawView.onePathEndBlock = ^(NSMutableDictionary *dict) {
        ...
        NSData *passData = [NSJSONSerialization dataWithJSONObject:passDic
                                                           options:NSJSONWritingPrettyPrinted
                                                             error:nil];
        [weakSelf.udpSocket sendData:passData toHost:@"127.0.0.1" port:8090 withTimeout:-1 tag:10010];
    };
    
    UIBarButtonItem *connectItem = [[UIBarButtonItem alloc] initWithTitle:@"连接" style:UIBarButtonItemStylePlain target:self action:@selector(didClickCreatSocketAction:)];
